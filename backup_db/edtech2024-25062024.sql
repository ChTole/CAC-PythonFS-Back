...
INSERT INTO `cuenta` VALUES (2,'usuariodeprueba@prueba.com.ar','72a37f8d3489876393c271ee564f2b478736ceea'),(7,'cristian.tole@bue.edu.ar','e902ed4d25f347eacce2633c7728c03f0f5b1503');
...
INSERT INTO `curso` VALUES (1,1,'2024-07-01','2024-09-30',1,10),(2,3,'2024-10-01','2024-12-30',2,5),(4,2,'2025-02-01','2025-04-30',1,5),(17,4,'2024-09-01','2024-11-30',4,7);
...
INSERT INTO `docente` VALUES (1,'Cosme','Fulanito','20123456780'),(2,'Emmet','Brown','30123456780'),(3,'Obi-Wan','Kenobi','50123456780'),(4,'Charles','Xavier','99123456789');
...
INSERT INTO `estudiante` VALUES (2,2,'Usuario','Probando','88774445','Terciario/Universitario incompleto'),(7,7,'Christian Ariel','Toledo','28666111','Terciario/Universitario incompleto');
...
CREATE TABLE `imagen` (
  ...
  `texto_alt` varchar(60) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `tema_id` (`tema_id`),
...
INSERT INTO `imagen` VALUES (1,3,'./img/cursos/CSS3.png','Logo de lenguaje CSS 3.'),(2,5,'./img/cursos/Django.png','Logo de framework Django.'),(3,3,'./img/cursos/html5.png','Logo de lenguaje HTML 5.'),(4,3,'./img/cursos/JavaScript.png','Logo de lenguaje JavaScript.'),(5,6,'./img/cursos/machine-learning.png','Logo de aprendizaje automático.'),(6,4,'./img/cursos/MySQL.png','Logo de MySQL.'),(7,1,'./img/cursos/python1.png','Logo de lenguaje Python.'),(8,2,'./img/cursos/python2.png','Logo de lenguaje Python.');
...
-- Dump completed on 2024-06-25 21:42:03
